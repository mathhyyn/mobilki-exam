...
class MyFormState extends State {
  ...
  Future AAA(String message) async {
    ...
    /// Ok, we will now sleep a while, in this gap you will see ping request/response messages being exchanged by the keep alive mechanism.
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text('Форма заполнена! $_body'),
