...
class MainActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvCeil: TextView = findViewById(R.id.tvCeil)
        tvCeil.setOnClickListener {
            tvExpression.text = tvExpression.text.toString() + "ceil"
        }
        val tvAcos: TextView = findViewById(R.id.tvAcos)
        tvAcos.setOnClickListener {
